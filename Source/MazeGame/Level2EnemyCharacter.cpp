...
#include "Level2EnemyCharacter.h"
...
// Sets default values
ALevel2EnemyCharacter::ALevel2EnemyCharacter()
{
...
void ALevel2EnemyCharacter::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void ALevel2EnemyCharacter::Tick(float DeltaTime)
{
	...
	if (bCanseePlayer != bPreviousCanSeePlayer) {
		if (bCanseePlayer) {
			GetWorldTimerManager().SetTimer(ThrowTimerHandle, this, &ALevel2EnemyCharacter::ThrowBall, ThrowingInterval, true, ThrowingDelay);
		}
		else {
...
void ALevel2EnemyCharacter::ThrowBall() {
